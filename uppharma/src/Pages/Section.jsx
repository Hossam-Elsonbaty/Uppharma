...
export default function Section() {
  ...
  const products = [
    ...
    { id: 1, name: "غوتشي ابسليوت عطر للنساء 90 مل", price: "2.5", image: ultramale, availability: "متبقي 2 فقط." },
    ...
    { id: 1, name: "جيفنشي جنتل مان عطر للرجال 100 مل", price: "6", image: ultramale, availability: "متبقي 2 فقط." },
    ...
    { id: 1, name: "غوتشي ابسليوت عطر للنساء 90 مل", price: "15", image: ultramale, availability: "متبقي 2 فقط." },
    ...
    { id: 1, name: "غوتشي ابسليوت عطر للنساء 90 مل", price: "2", image: ultramale, availability: "متبقي 2 فقط." },
